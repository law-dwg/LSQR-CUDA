...
make run
```
NOTE: Before compiling, please check your GPUs compute capability. In the Makefile it is currently set to sm_50. For best results, change this to match the capability of your GPU hardware.
